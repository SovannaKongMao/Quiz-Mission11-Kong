...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('/assets/')); ?>/library/font-awesome-4.3.0/css/font-awesome.min.css">
...
=========================================================================================================================-->
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('/assets/')); ?>/images/icon.png">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/assets/')); ?>/css/animate.css">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/assets/')); ?>/css/owl.carousel.css">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/assets/')); ?>/css/owl.theme.css">
...
=========================================================================================================================-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/assets/')); ?>/library/bootstrap/css/bootstrap-theme.min.css">

    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/assets/')); ?>/library/bootstrap/css/bootstrap.css">
...
=========================================================================================================================-->
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/assets/')); ?>/css/color/themecolor.css">
                                  ...
                                  <div class="row pd-box-small">
                                    <div class="col-md-3 col-sm-3 hidden-xs departure-boder-right layout-operaotr-log">
                                      <div href="" class="container-logo-operator subtitle">
                                          ...
                                          <p class="name-operator title label-operator">   <?php echo e($schedule->operator_name); ?></p>
                                    ...
                                    <div class="col-md-5 col-sm-5 col-xs-6 subtitle pl-left">
                                      <p>
                                        ...
                                        <span class="title name"><?php echo e($schedule->origin); ?></span>
                                      </p>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-sm-4 col-xs-6 subtitle pd-right">
                                      <p>
                                        ...
                                        <span class="title name"><?php echo e($schedule->destination); ?></span>
                                      </p>
                                    </div>

                                    <div class="col-md-3 col-sm-3 col-xs-4 subtitle departure-boder-right pl-left-depart" style="padding-top: 25px;">
                                      <p class="time">Departure Time: <?php echo e($schedule->departure_time); ?></p>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-4 subtitle departure-boder-left pd-right" style="padding-top: 25px;">
                                      <p class="time">Arrival Time: <br> <?php echo e($schedule->arrival_time); ?></p>
                                    ...
                                    <div class="row container-detail hidden-sm hidden-xs" style="margin-right: -2px; padding-top: 30px ">
                                      <div class="col-sm-6 pd pt-10 text-right pull-right pr-15" >
                                        ...
                                        <span class="label-seat-avaible"><?php echo e($schedule->max_seat); ?></span>
                                      </div>
                                    </div>
                                        ...
                                        <div class="modal-body">
                                            <form action="/addTicket" method="post">
                                                ...
                                                <input type="hidden" class="form-control" name="schedule_id"
                                                     required value="<?php echo e($schedule->schedule_id); ?>">
                                                <input type="hidden" class="form-control" name="date"
                                                required value="<?php echo e($date); ?>">
                                                <input type="hidden" class="form-control" name="user_id"
                                                required value="<?php echo e(Auth::user()->id); ?>">
                                                ...
                                                <p>
                                                  <p>Choose payment method : <br>
                                                    <label>
                                                      ...
                                                      <img src="<?php echo e(asset('/assets/')); ?>/images/ABA.jpg" class="logo" alt="Option 1">
                                                    </label>
                                                    
                                                    <label>
                                                      <input type="radio" name="payment" value="big">
                                                      <img src="<?php echo e(asset('/assets/')); ?>/images/acleda.png" class="logo" alt="Option 2">
                                                    </label>

                                                    <label>
                                                      <input type="radio" name="payment" value="big">
                                                      <img src="<?php echo e(asset('/assets/')); ?>/images/Pipay.png" class="logo" alt="Option 2">
                                                    </label>

                                                    <label>
                                                      <input type="radio" name="payment" value="big">
                                                      <img src="<?php echo e(asset('/assets/')); ?>/images/cash.png" class="logo" alt="Option 2">
                                                    </label>
...
<?php echo $__env->make('layouts.main.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mengly\Desktop\Paragon-Learning\year3\web_dev2\Final\bookMeBus\resources\views/user/displaySchedule.blade.php ENDPATH**/ ?>