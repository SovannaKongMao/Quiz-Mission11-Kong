    ...
    <div class="container" style="padding-top: 100px; " >
        <div class="row" >
            <div class=" col-md-12 col-sm-12 text-center">
                ...
                <div class="btn-bar">
                    <a href="<?php echo e(url('/schedule')); ?>" class="btn btn-custom theme_background_color">Make Your Booking Now</a> 
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.main.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mengly\Desktop\Paragon-Learning\year3\web_dev2\Final\bookMeBus\resources\views/home.blade.php ENDPATH**/ ?>