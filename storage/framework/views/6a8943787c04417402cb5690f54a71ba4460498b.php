    ...
    <div class="row" style="padding-top:80px">
        <div class="col-md-12 col-sm-12 text-center">
            ...
            <div class="alert alert-success">
                <h5 class=""><?php echo e(session('status')); ?></h5>
            </div>
            <?php endif; ?>
            <br>
...
<?php echo $__env->make('layouts.main.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mengly\Desktop\Paragon-Learning\year3\web_dev2\Final\bookMeBus\resources\views/user/viewSearch.blade.php ENDPATH**/ ?>