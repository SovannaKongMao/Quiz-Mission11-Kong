    ...
    <aside class="main-sidebar sidebar-dark-success elevation-4">
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="image">
                    <img src="<?php echo e(asset('/assets/')); ?>/images/trainlg.png" class="img-circle elevation-2" alt="User Image">
                </div>
                <div class="info">
           ...
           with font-awesome or any other icon font library -->
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(url('/admin/dashboard/users')); ?>" class="nav-link 
                        active                            ">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(url('/admin/dashboard/schedule')); ?>" class="nav-link 
                                                    ">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(url('/admin/dashboard/route')); ?>" class="nav-link      ">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(url('/admin/dashboard/operator')); ?>" class="nav-link      ">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo e(url('/admin/dashboard/payment')); ?>" class="nav-link      ">
                            ...
                            <table style="width: 100%;" id="example1" style="align-items: stretch;"
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>7800000000</td>
                                        <td><img src="<?php echo e(asset('/assets/')); ?>/uploads/404a6378027a553d980b99162a5b4ce8.png"
                                    ...
                                    <tr>
                                        ...
                                        <td>7000000000</td>
                                        <td><img src="<?php echo e(asset('/assets/')); ?>/uploads/f3fc8566140434f0a3f47303c62d5146.jpg"
                                                class="img img-rounded" width="80" height="80" /></td>
...
<?php echo $__env->make('layouts.admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Mengly\Desktop\Paragon-Learning\year3\web_dev2\Final\bookMeBus\resources\views/admin/userControl.blade.php ENDPATH**/ ?>